...
import { Users, FileText, PenTool, Star, Search, SlidersHorizontal } from "lucide-react"
        ...
        <TabsContent value="all" className="space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card className="transition-shadow hover:shadow-lg">
              ...
              <CardContent>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Practice real interview questions with AI. Build confidence and improve your answers with instant
                  feedback.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="transition-shadow hover:shadow-lg">
              ...
              <CardContent>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Generate full-length articles in seconds using AI. Great for blogs, assignments, and content creation.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="transition-shadow hover:shadow-lg">
              ...
              <CardContent>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Instantly correct grammar, punctuation, and sentence structure. Get clear suggestions to improve your
                  writing.
                </p>
              </CardContent>
            </Card>
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <CardDescription>Total performance progress statas</CardDescription>
                  </div>
                  <Badge className="bg-green-100 text-green-700 hover:bg-green-100">+ 235,21%</Badge>
                </div>
              </CardHeader>
              <CardContent>
                <div className="mb-6 grid grid-cols-2 gap-4">
                  <div className="rounded-lg border p-4">
                    <div className="mb-2 text-sm text-muted-foreground">Credit Score</div>
                    <div className="text-3xl font-bold">2,442</div>
                  </div>
                  <div className="rounded-lg border p-4">
                    <div className="mb-2 text-sm text-muted-foreground">Loss Credit Score</div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-muted-foreground">Up Coming</span>
                    </div>
